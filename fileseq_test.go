	...
	table := []TestSet{
		{
			...
			tests: map[string]string{
				...
				"testdata/seqA.@@@@.exr":         "testdata/seqA.1,3-6,8-10####.exr",
				"testdata/seqA.@.jpg":            "",
				"testdata/complex.@@@@.tar.gz":   "testdata/complex.5-7####.tar.gz",
				"testdata/complex_ext/@.a.jpg":   "testdata/complex_ext/1-3#.a.jpg",
				"testdata/complex_ext/@@@.1.ext": "testdata/complex_ext/100-102###.1.ext",
